...
from Proboscidea_Volcanium import INPUT

def getData() -> dict:
    return [[line.split(' ')[1], int(line.split(' ')[4].split('=')[1][:-1]), [l.replace(',', '') for l in line.split(' ')[9:]]] for line in INPUT.splitlines() if len(line) != 0]
