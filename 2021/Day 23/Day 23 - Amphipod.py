import heapq as hq
from Amphipod import INPUT_P1, INPUT_P2
...
def partOne(data: tuple[tuple[str]]) -> int:
    goal: tuple[tuple[str]] = (("A", "A"), ("B", "B"), ("C", "C"), ("D", "D"))
    return dijkstra(data, goal)

def partTwo(data: tuple[tuple[str]]) -> int:
    goal: tuple[tuple[str]] = (("A", "A", "A", "A"), ("B", "B", "B", "B"), ("C", "C", "C", "C"), ("D", "D", "D", "D"))
    return dijkstra(data, goal)

if __name__ == "__main__":
    print(partOne(INPUT_P1))
    print(partTwo(INPUT_P2))
